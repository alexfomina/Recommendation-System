...
def my_account(username):
    ...
    try:
        ...
        if user_details:
            return f"**Username:** {user_details['username']}\n**Name:** {user_details['name']}\n**Profile:** {user_details['profile']}\n**Date Created:** {user_details['date_created']}"
        else:
...
def gradio_app():
    with gr.Blocks() as app:
        gr.Markdown("## Welcome to the Course Recommendation System")
        ...
        with gr.Tab("My Account"):
            ...
            account_button = gr.Button("View My Account")
            account_output = gr.Textbox(label="Account Details", interactive=False)

            account_button.click(my_account, account_username, account_output)

        with gr.Tab("Courses"):
            courses_button = gr.Button("View All Courses")
            courses_output = gr.Textbox(label="Available Courses", interactive=False)

            courses_button.click(view_courses, [], courses_output)
